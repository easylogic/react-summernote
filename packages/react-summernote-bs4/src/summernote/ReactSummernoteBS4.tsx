...
import { Summernote, SummernoteProps, SummernoteContext, SummernoteCustomButtonProps } from '@easylogic/react-summernote';
    ...
    return (context: SummernoteContext) => {
        ...
        if (opt.title && !opt.element ) {
            ...
            if (opt?.element) {
                ...
                ReactDOM.createRoot(el[0]).render(React.createElement<Attribute>(opt.element, props))
            }
