...
// src/telemetry/index.ts
var hh = /* @__PURE__ */ o((e) => e.startsWith("example-button--") || e.startsWith("example-header--") || e.startsWith("example-page--"), "i\
sExampleStoryId"), gh = /* @__PURE__ */ o(async (e, t = {}, r = {}) => {
  e !== "boot" && await Zs();
  let n = {
    eventType: e,
    payload: t
