...
}, Py = Object.keys(I.modifier), zf = Object.keys(I.color), Xf = Object.keys(I.bgColor), Oy = [...zf, ...Xf];
function Qf() {
...
var ud = ze(), Dy = ze({ level: pa ? pa.level : 0 });
var jr = ud;
...
// src/telemetry/index.ts
var ld = /* @__PURE__ */ o((e) => e.startsWith("example-button--") || e.startsWith("example-header--") || e.startsWith("example-page--"), "i\
