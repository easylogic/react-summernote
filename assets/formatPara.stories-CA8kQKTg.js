import{R as t}from"./index-CyuyzGzS.js";import{d as E}from"./util-jfGB622S.js";import{R as h}from"./ReactSummernoteLite-Ck5Kd2ss.js";import"./jsx-runtime-C-FJrwGG.js";import"./Summernote-BFqpfptl.js";import"./client-vtXVjOFi.js";import"./index-Cpnl9FGv.js";const v=({initialContent:f})=>{const[n,C]=t.useState(null),g=()=>{n&&n.summernote("formatPara")};return t.createElement("div",{style:E},t.createElement("h1",null,"formatPara"),t.createElement("p",null,"현재 단락을 ","<p>"," 태그로 변경합니다."),t.createElement("pre",null,`
        <ReactSummernoteLite 
          id="sample" 
          onInit={({ note }) => {
