import{R as e}from"./index-CyuyzGzS.js";import{d as g}from"./util-jfGB622S.js";import{R as l}from"./ReactSummernoteLite-Ck5Kd2ss.js";import"./jsx-runtime-C-FJrwGG.js";import"./Summernote-BFqpfptl.js";import"./client-vtXVjOFi.js";import"./index-Cpnl9FGv.js";const m=()=>{let o=null;function c(){const t=o.summernote("getLastRange").getWordsMatchRange(/@[a-z ]+/i);console.log(t?t.toString():"text could not found")}return e.createElement("div",{style:g},e.createElement("h1",null,"getWordsMatchRange(regex)"),e.createElement("p",null,"returns range for words before cursor that match with a Regex"),e.createElement("pre",null,`
            // range : 'hi @Peter Pan'
