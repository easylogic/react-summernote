import{r as l,R as e}from"./index-RYns6xqu.js";import{d as p}from"./util-jfGB622S.js";import{R as a}from"./ReactSummernoteLite-Chf2t645.js";import"./jsx-runtime-DEdD30eg.js";import"./client-ngufn95y.js";import"./index-D16Yfzz8.js";import"jQuery";import"./Summernote-D81Bv8uQ.js";const g={title:"Font Style API/Font Size",component:a},u={render:s=>{const n=l.useRef(null),i=()=>{n.current&&n.current.summernote("fontSize",30)};return e.createElement("div",{style:p},e.createElement("h1",null,"fontSize"),e.createElement("p",null,"글꼴 크기를 설정합니다."),e.createElement("pre",null,`
          <ReactSummernoteLite 
            id="sample" 
            onInit={({ note }) => {
