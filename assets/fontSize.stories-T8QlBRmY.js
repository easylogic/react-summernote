import{r as l,R as e}from"./index-CyuyzGzS.js";import{d as p}from"./util-jfGB622S.js";import{R as a}from"./ReactSummernoteLite-Ck5Kd2ss.js";import"./jsx-runtime-C-FJrwGG.js";import"./Summernote-BFqpfptl.js";import"./client-vtXVjOFi.js";import"./index-Cpnl9FGv.js";const x={title:"Font Style API/Font Size",component:a},u={render:s=>{const n=l.useRef(null),i=()=>{n.current&&n.current.summernote("fontSize",30)};return e.createElement("div",{style:p},e.createElement("h1",null,"fontSize"),e.createElement("p",null,"글꼴 크기를 설정합니다."),e.createElement("pre",null,`
          <ReactSummernoteLite 
            id="sample" 
            onInit={({ note }) => {
