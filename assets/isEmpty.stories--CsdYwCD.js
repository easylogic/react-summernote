import{r as l,R as e}from"./index-CyuyzGzS.js";import{d as u}from"./util-jfGB622S.js";import{R as s}from"./ReactSummernoteLite-BDzohGId.js";import"./jsx-runtime-C-FJrwGG.js";import"./client-vtXVjOFi.js";import"./index-Cpnl9FGv.js";import"./Summernote-94-QudP_.js";const I={title:"Basic API/IsEmpty",component:s},n={render:()=>{const t=l.useRef(null),p=()=>{t.current&&t.current.summernote("isEmpty")&&console.log("summernote가 비어 있습니다")};return e.createElement("div",{style:u},e.createElement("h1",null,"isEmpty"),e.createElement("p",null,"에디터 내용이 비어 있는지 여부를 반환합니다. 편집 영역은 포커스를 위해 ","<p><br></p>","가 필요하며, 에디터 내용이 비어 있어도 마찬가지입니다. 따라서 Summernote는 에디터 내용이 비어 있는지 확인하는 데 도움이 되는 이 메서드를 지원합니다."),e.createElement("pre",null,`
...
}`,...(m=(r=n.parameters)==null?void 0:r.docs)==null?void 0:m.source}}};const S=["IsEmpty"];export{n as IsEmpty,S as __namedExportsOrder,I as default};
