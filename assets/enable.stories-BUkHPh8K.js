import{R as e,r as s}from"./index-CyuyzGzS.js";import{d as i}from"./util-jfGB622S.js";import{R as l}from"./ReactSummernoteLite-BDzohGId.js";import"./jsx-runtime-C-FJrwGG.js";import"./client-vtXVjOFi.js";import"./index-Cpnl9FGv.js";import"./Summernote-94-QudP_.js";const C={title:"Basic API/Enable",component:l},u=()=>{const n=s.useRef(null),m=e.useCallback(()=>{n.current&&n.current.summernote("enable")},[]);return e.createElement("div",{style:i},e.createElement("h1",null,"Enable"),e.createElement("p",null,"If you want to enable editor again, call API with enable."),e.createElement("pre",null,`
        <ReactSummernoteLite 
          id="sample" 
          onInit={({ note }) => {
