import{R as e}from"./index-RYns6xqu.js";import{d as l}from"./util-jfGB622S.js";import{R as m}from"./ReactSummernoteLite-Chf2t645.js";import"./jsx-runtime-DEdD30eg.js";import"./client-ngufn95y.js";import"./index-D16Yfzz8.js";import"jQuery";import"./Summernote-D81Bv8uQ.js";const S={title:"Insertion API/CreateLink and Unlink",component:m},n={render:()=>{const t=e.useRef(null),u=()=>{t.current&&t.current.summernote("createLink",{text:"This is the Summernote's Official Site",url:"http://summernote.org",isNewWindow:!0})},s=()=>{t.current&&t.current.summernote("unlink")};return e.createElement("div",{style:l},e.createElement("h1",null,"createLink, unlink"),e.createElement("p",null,"Create link and unlink."),e.createElement("pre",null,`
          <ReactSummernoteLite
            id="sample"
            onInit={({ note }) => {
